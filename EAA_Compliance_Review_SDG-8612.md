...
| A.3 | Hardware | Color‑only status indicators have non‑color alternative | Ethernet and SFP LEDs rely on color only | **CONFIRMED GAP** | Same as A.1 |
